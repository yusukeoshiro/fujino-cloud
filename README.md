...
gcloud --project=fujino-cloud run deploy  fujino-cloud-dev --image=asia-northeast1-docker.pkg.dev/fujino-cloud/containers/svelte-app:latest --region=asia-northeast1
